...
WINDOW_TITLE: str = "pygame_step_14" # Titre de la fenêtre du jeu
...
class Game:
    ...
    # __actors_sprites: list[ActorSprite]
    ...
    def __init_actors(self) -> None:
        ...
        actor_sprite = ActorSprite(actor, pygame.Color(pygame.color.THECOLORS["magenta"]))
        # self.__actors_sprites.append(actor_sprite)
        # Permet d'ajouter un pygame.sprite_Group à un autre
        # Tolère l'ajout d'un pygame.sprite.Sprite
    ...
    def __draw_actors(self) -> None:
        # for actor_sprite in self.__actors_sprites:
        #    actor_sprite.draw(self.__screen)
